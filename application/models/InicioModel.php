...
class InicioModel extends CI_Model {
    ...
    public function votoGuardarDeporIndiv($datos){
    ...
    public function votoGuardarEquipoIndiv($datos){
        $res = array("error" => false,"msg" => '');
        try {
            $this->db->trans_begin();
            if($datos['pk_voto'] == 0){
    ...
    public function votoGuardarDeporConj($datos){
        $res = array("error" => false,"msg" => '');
        try {
            $this->db->trans_begin();
            if($datos['pk_voto'] == 0){
    ...
    public function votoGuardarEquipoConj($datos){
        $res = array("error" => false,"msg" => '');
        try {
            $this->db->trans_begin();
            if($datos['pk_voto'] == 0){
    ...
    public function votoGuardarDeporPp($datos){
        $res = array("error" => false,"msg" => '');
        try {
            $this->db->trans_begin();
            if($datos['pk_voto'] == 0){
    ...
    public function votoGuardarEquipoPp($datos){
        $res = array("error" => false,"msg" => '');
        try {
            $this->db->trans_begin();
            if($datos['pk_voto'] == 0){
    ...
    public function votoGuardarMunicipal($datos){
        $res = array("error" => false,"msg" => '');
        try {
            $this->db->trans_begin();
            if($datos['pk_voto'] == 0){
