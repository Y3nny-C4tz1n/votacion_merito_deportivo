...
$route['ajax/guardarVotoDeporIndiv'] = 'InicioController/guardarVotoDeporIndiv';
$route['ajax/guardarVotoEquipoIndiv'] = 'InicioController/guardarVotoEquipoIndiv';
$route['ajax/guardarVotoDeporConj'] = 'InicioController/guardarVotoDeporConj';
$route['ajax/guardarVotoEquipoConj'] = 'InicioController/guardarVotoEquipoConj';
$route['ajax/guardarVotoDeporPp'] = 'InicioController/guardarVotoDeporPp';
$route['ajax/guardarVotoEquipoPp'] = 'InicioController/guardarVotoEquipoPp';
$route['ajax/guardarVotoMunicipal'] = 'InicioController/guardarVotoMunicipal';
$route['ajax/cargarFormularioDeporIndiv'] = 'InicioController/loadFormularioDeporIndiv';
$route['ajax/cargarFormularioEquipoIndiv'] = 'InicioController/loadFormularioEquipoIndiv';
$route['ajax/cargarFormularioDeporConj'] = 'InicioController/loadFormularioDeporConj';
$route['ajax/cargarFormularioEquipoConj'] = 'InicioController/loadFormularioEquipoConj';
$route['ajax/cargarFormularioDeporPp'] = 'InicioController/loadFormularioDeporPp';
$route['ajax/cargarFormularioEquipoPp'] = 'InicioController/loadFormularioEquipoPp';
$route['ajax/cargarFormularioMunicipal'] = 'InicioController/loadFormularioMunicipal';
...
$route['rentrenador'] = 'ResultadoeController';
$route['rfomento'] = 'ResultadofController';
$route['ajax/listadoRdeportista'] = 'ResultadodController/listRdeportista';
$route['ajax/listadoRentrenador'] = 'ResultadoeController/listRentrenador';
$route['ajax/listadoRfomento'] = 'ResultadofController/listRfomento';
...
#VOTO
 ...
 $route['generarReporte'] = 'ResultadofController/downReportePDF';
